      ...
      <v-row class="home-service__contents">
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/work_01.jpg" alt="ディレクション">
            </div>
        ...
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/work_02.jpg" alt="コーディング">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
        ...
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/work_03.jpg" alt="デザイン">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
